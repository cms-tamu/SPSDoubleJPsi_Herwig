...
\begin{document}
\appendix
\section[xxx]{\textsc{ThePEG} version 1.7.0 \cite{ThePEG} Run Information}
Run name: \textbf{LHC-SSDJpsi}:\\
...
\item The Higgs width was calculated as in \cite{Seymour:1995qg}.
